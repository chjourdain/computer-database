...
import com.excilys.formation.computerdatabase.dao.GenericDao;
...
public class CLIC {
	...
	public static void listComputer() {
		...
		while (pageA != -1) {
			...
			ArrayList<Computer> cl = cD.list(pageA);
			for (Computer c : cl) {
	...
	public static int pagination(GenericDao<Object> cd, Integer page) {
		_OUT.print("(0) |< ");
		_OUT.print("(1) << ");
		_OUT.print("(2) >> ");
		_OUT.print("(3) |> ");
